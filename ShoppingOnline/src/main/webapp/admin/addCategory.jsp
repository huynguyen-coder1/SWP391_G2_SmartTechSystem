...
<head>
    <meta charset="UTF-8">
    <title>Thêm danh mục - TechMart Admin</title>
...
<div class="main-content">
    <div class="form-card">
        <div class="d-flex justify-content-between align-items-center mb-4">
            <h2><i class="fas fa-folder-plus"></i> Thêm danh mục mới</h2>
            <a href="categoryManagement" class="btn btn-outline-primary">
        ...
        <form action="addCategory" method="post">
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control" name="categoryName"
                       placeholder="VD: Laptop, Chuột, Bàn phím..." required>
            </div>
            ...
            <div class="text-end mt-4">
                <button type="submit" class="btn-submit">
                    <i class="fas fa-check-circle"></i> Lưu danh mục
                </button>
            </div>
        </form>
    </div>
