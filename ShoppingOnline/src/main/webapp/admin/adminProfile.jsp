...
<head>
    <meta charset="UTF-8">
    <title>Hồ sơ Quản trị - TechMart Admin</title>
    ...
    <style>
        ...
        .profile-card {
            ...
            max-width: 900px;
            margin: 0 auto;
            position: relative; /* quan trọng để căn nút */
            transition: 0.4s;
        ...
        .back-btn:hover {
            background: linear-gradient(135deg, #5a6edc, #6d3c9c);
        }
...
<div class="main-content">
    <div class="profile-card">
        <!-- Nút quay lại -->
        <a href="${pageContext.request.contextPath}/admin/adminPage.jsp" class="back-btn">
            <i class="fas fa-arrow-left me-1"></i> Quay lại
        </a>

        <div class="text-center mb-4">
            <img src="${empty admin.avatarUrl ? 'https://cdn-icons-png.flaticon.com/512/149/149071.png' : admin.avatarUrl}"
                 alt="Avatar" class="avatar mb-3">
            <h3 class="fw-bold mb-1">${admin.fullName}</h3>
        ...
        <c:if test="${not empty message}">
            <div class="alert alert-info text-center fade-message">
                ${message}
            </div>
        </c:if>
            ...
            <div class="row">
                ...
                <div class="col-md-6 mb-3">
                    ...
                    <input type="date" name="dateOfBirth"
                           value="<%= admin.getDateOfBirth() != null ? new java.text.SimpleDateFormat("yyyy-MM-dd").format(admin.getDateOfBirth()) : "" %>"
                           class="form-control">
                </div>
