...
<%
    User shipper = (User) request.getAttribute("shipper");
...
<head>
    <meta charset="UTF-8">
    <title>Hồ sơ Shipper - TechMart</title>
...
<div class="main-content">
    <div class="profile-card">
        <a href="${pageContext.request.contextPath}/shipper/shipperPage.jsp" class="back-btn">
            <i class="fas fa-arrow-left me-1"></i> Quay lại
        </a>
        <div class="text-center mb-4">
            <img src="${empty shipper.avatarUrl ? 'https://cdn-icons-png.flaticon.com/512/149/149071.png' : shipper.avatarUrl}"
                 alt="Avatar" class="avatar mb-3">
            <h3 class="fw-bold mb-1">${shipper.fullName}</h3>
            <c:forEach var="role" items="${shipper.roles}">
        ...
        <form action="${pageContext.request.contextPath}/shipper/shipperProfile" method="post">
            <div class="row">
                <div class="col-md-6 mb-3">
                    <label class="form-label"><i class="fas fa-user me-1"></i> Họ và tên</label>
                    <input type="text" name="fullName" value="${shipper.fullName}" class="form-control" required>
                </div>
                <div class="col-md-6 mb-3">
                    <label class="form-label"><i class="fas fa-envelope me-1"></i> Email</label>
                    <input type="email" value="${shipper.email}" class="form-control" disabled>
                </div>
                <div class="col-md-6 mb-3">
                ...
                <div class="col-md-6 mb-3">
                    ...
                    <input type="date" name="dateOfBirth"
                           value="<%= shipper.getDateOfBirth() != null ? new java.text.SimpleDateFormat("yyyy-MM-dd").format(shipper.getDateOfBirth()) : "" %>"
                           class="form-control">
                </div>
                <div class="col-md-12 mb-3">
                    <label class="form-label"><i class="fas fa-map-marker-alt me-1"></i> Địa chỉ</label>
                    <input type="text" name="address" value="${shipper.address}" class="form-control">
                </div>
            </div>
