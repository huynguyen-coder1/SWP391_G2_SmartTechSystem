...
<head>
    <meta charset="UTF-8">
    <title>Thêm thương hiệu - TechMart Admin</title>
...
<div class="main-content">
    <div class="form-card">
        <div class="d-flex justify-content-between align-items-center mb-4">
            <h2><i class="fas fa-tag"></i> Thêm thương hiệu mới</h2>
        ...
        <form action="addBrand" method="post">
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control" name="brandName"
                       placeholder="VD: Apple, Samsung, Logitech..." required>
            </div>

            <div class="mb-3">
                <label class="form-label">Mô tả</label>
                <textarea class="form-control" name="description" rows="3"
                          placeholder="Mô tả ngắn về thương hiệu (tùy chọn)"></textarea>
            </div>
            ...
            <div class="text-end mt-4">
                <button type="submit" class="btn-submit">
                    <i class="fas fa-check-circle"></i> Lưu thương hiệu
                </button>
            </div>
        </form>
    </div>
